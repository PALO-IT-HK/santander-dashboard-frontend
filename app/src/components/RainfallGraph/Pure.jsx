          ...
          { data.length !== 0
            ? (<ResponsiveContainer minWidth={1024}>
              <ComposedChart data={data} margin={{bottom: 100}}>
                ...
                <YAxis yAxisId='bar' tick={{fontFamily: 'Rubik', fontSize: 12}} orientation='right' label={{value: 'Bikes Usage', position: 'middle', angle: -270, dx: 25, dy: -50, fontFamily: 'Rubik', fontSize: 12}} />
